...
Как узнать статус репликации?
psql -c "select client_addr,sent_lsn,write_lsn,flush_lsn,replay_lsn,write_lag,flush_lag,replay_lag  from pg_stat_replication;"
В колонках client_addr,sent_lsn,write_lsn,flush_lsn,replay_lsn должны быть одинаковые числа, а в write_lag,flush_lag,replay_lag должно быть пусто.
